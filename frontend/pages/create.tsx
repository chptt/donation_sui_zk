...
import { CONTRACT_ADDRESS, MODULE_NAME } from "@/lib/aptosClient";
...
export default function CreateCampaign() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const goalInOctas = parseFloat(formData.goal_amount) * 100000000;

      const payload: any = {
        data: {
          function: `${CONTRACT_ADDRESS}::${MODULE_NAME}::create_campaign`,
          functionArguments: [
            formData.title,
            formData.description,
            formData.charity_type,
            goalInOctas.toString(),
            CONTRACT_ADDRESS,
          ],
        },
      };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600">
            Launch your charity campaign on the blockchain and start making a difference
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe your campaign, how the funds will be used, and the impact it will make..."
              />
            </div>
                ...
                {charityOptions.map((option) => (
                  ...
                  >
                    ...
                    <div className={`font-semibold ${
                      formData.charity_type === option.value ? "text-indigo-600" : "text-gray-700"
                    }`}>
                      {option.label}
                    </div>
                  </button>
