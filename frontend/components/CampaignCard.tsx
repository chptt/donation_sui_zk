...
import { Campaign } from "@/lib/aptosClient";
          ...
          <div className="flex justify-between items-center pt-4 border-t border-gray-100">
            <div>
              ...
              <p className="text-lg font-bold text-gray-900">
                {(campaign.total_donated / 100000000).toFixed(2)} <span className="text-sm text-gray-500">APT</span>
              </p>
            </div>
            <div className="text-right">
              <p className="text-xs text-gray-500 mb-1">Goal</p>
              <p className="text-lg font-bold text-gray-900">
                {(campaign.goal_amount / 100000000).toFixed(2)} <span className="text-sm text-gray-500">APT</span>
              </p>
            </div>
          </div>
        </div>
